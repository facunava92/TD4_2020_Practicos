...
read_vhdl -library xil_defaultlib {
  /run/media/fnavarro/DATA/Git/6to/Tecnicas_Digitales_IV/Practicos/Trabajo_Practico_1/TP1/TP1.srcs/sources_1/new/bin2bcd.vhd
...
synth_design -top motorcc_cl -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef motorcc_cl.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file motorcc_cl_utilization_synth.rpt -pb motorcc_cl_utilization_synth.pb"
